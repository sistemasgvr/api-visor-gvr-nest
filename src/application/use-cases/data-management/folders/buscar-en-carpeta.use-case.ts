...
import { BuscarEnCarpetaDto } from '../../../dtos/data-management/folders/buscar-en-carpeta.dto';

@Injectable()
export class BuscarEnCarpetaUseCase {
  constructor(
  ...
  async execute(
    ...
    return await this.autodeskApiService.buscarEnCarpeta(
      token.tokenAcceso,
      projectId,
      folderId,
      dto.filters || {},
