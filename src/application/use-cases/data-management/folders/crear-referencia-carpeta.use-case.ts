...
import { CrearReferenciaDto } from '../../../dtos/data-management/folders/crear-referencia.dto';

@Injectable()
export class CrearReferenciaCarpetaUseCase {
  constructor(
  ...
  async execute(
    ...
    return await this.autodeskApiService.crearReferenciaCarpeta(
      token.tokenAcceso,
      projectId,
      folderId,
      dto.data,
