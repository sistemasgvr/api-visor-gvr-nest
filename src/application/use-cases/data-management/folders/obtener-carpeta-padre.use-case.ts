...
import { ObtenerCarpetaPadreDto } from '../../../dtos/data-management/folders/obtener-carpeta-padre.dto';

@Injectable()
export class ObtenerCarpetaPadreUseCase {
  constructor(
  ...
  async execute(
    ...
    return await this.autodeskApiService.obtenerCarpetaPadre(
      token.tokenAcceso,
      projectId,
      folderId,
    );
