...
import { ObtenerCarpetaPorIdDto } from '../../../dtos/data-management/folders/obtener-carpeta-por-id.dto';

@Injectable()
export class ObtenerCarpetaPorIdUseCase {
  constructor(
  ...
  async execute(
    ...
    return await this.autodeskApiService.obtenerCarpetaPorId(
      token.tokenAcceso,
      projectId,
      folderId,
    );
