...
import { ObtenerReferenciasDto } from '../../../dtos/data-management/folders/obtener-referencias.dto';

@Injectable()
export class ObtenerReferenciasUseCase {
  constructor(
  ...
  async execute(
    ...
    return await this.autodeskApiService.obtenerReferenciasCarpeta(
      token.tokenAcceso,
      projectId,
      folderId,
    );
