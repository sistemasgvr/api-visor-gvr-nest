...
import { ObtenerEstadoDescargaDto } from '../../../dtos/data-management/projects/obtener-estado-descarga.dto';

@Injectable()
export class ObtenerEstadoDescargaUseCase {
  constructor(
  ...
  async execute(
    ...
    return await this.autodeskApiService.obtenerEstadoDescarga(
      token.tokenAcceso,
      projectId,
      downloadId,
    );
