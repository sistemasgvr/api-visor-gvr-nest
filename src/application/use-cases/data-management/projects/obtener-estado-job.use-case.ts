...
import { ObtenerEstadoJobDto } from '../../../dtos/data-management/projects/obtener-estado-job.dto';

@Injectable()
export class ObtenerEstadoJobUseCase {
  constructor(
  ...
  async execute(
    ...
    return await this.autodeskApiService.obtenerEstadoJob(
      token.tokenAcceso,
      projectId,
      jobId,
    );
