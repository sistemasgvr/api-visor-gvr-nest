...
import { ObtenerProyectoPorIdDto } from '../../../dtos/data-management/projects/obtener-proyecto-por-id.dto';

@Injectable()
export class ObtenerProyectoHubPorIdUseCase {
  constructor(
