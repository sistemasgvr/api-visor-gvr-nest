...
import { ActualizarVersionDto } from '../../../dtos/data-management/versions/actualizar-version.dto';

@Injectable()
export class ActualizarVersionUseCase {
  constructor(
  ...
  async execute(
    ...
    return await this.autodeskApiService.actualizarVersion(
      token.tokenAcceso,
      projectId,
      versionId,
      dto.data,
