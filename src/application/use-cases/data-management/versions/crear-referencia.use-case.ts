...
import { CrearReferenciaDto } from '../../../dtos/data-management/versions/crear-referencia.dto';

@Injectable()
export class CrearReferenciaUseCase {
  constructor(
  ...
  async execute(
    ...
    return await this.autodeskApiService.crearReferenciaVersion(
      token.tokenAcceso,
      projectId,
      versionId,
      dto.data,
