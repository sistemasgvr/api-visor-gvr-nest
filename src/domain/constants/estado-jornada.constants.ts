...
export const ID_ESTADO_JORNADA_ALERTA = 398;
export const ID_ESTADO_JORNADA_INCOMPLETO = 399;
export const ID_ESTADO_JORNADA_COMPLETADO = 400;
export const ID_ESTADO_JORNADA_CULMINADO = 401;
