...
export class ExportacionIncidenciasService {
    ...
    async exportarPDF(
        ...
        const { templateData, renderOptions } = await IssueReportMapper.toTemplateData({
    ...
    private getStatusLabel(status: string): string {
        const labels: Record<string, string> = {
            draft: 'Borrador', open: 'Abierto', pending: 'Pendiente',
            'in-progress': 'En Progreso', in_review: 'En revisión', closed: 'Cerrado',
        };
